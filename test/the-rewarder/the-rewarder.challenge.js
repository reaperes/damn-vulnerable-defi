...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerContract = await ethers.getContractFactory('TheRewarderAttacker', attacker);
        const attackerContract = await AttackerContract.deploy(this.flashLoanPool.address, this.rewarderPool.address, this.liquidityToken.address, this.rewardToken.address);
