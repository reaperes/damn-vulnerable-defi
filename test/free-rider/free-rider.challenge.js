...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerContract = await ethers.getContractFactory('FreeRiderAttacker', attacker);
        ...
        await attackerContract.connect(attacker).attack({ value: ethers.utils.parseEther('0.1') });
    });
